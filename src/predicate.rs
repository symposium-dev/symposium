...
///
/// This is a re-export of [`symposium_sdk::predicate::SelectedCrate`] — the
/// same type plugin authors serialize on stdout.
pub use symposium_sdk::predicate::SelectedCrate as WitnessCrate;
