...
## [0.5.0](https://github.com/symposium-dev/symposium/compare/symposium-v0.4.0...symposium-v0.5.0) - 2026-09-24
...
- *(enablement)* `disable` is the last word, `use` included
...
- Merge pull request #299 from Fluzko/follow-symlinks
- clear the standing clippy warnings
- *(crate-authors)* the hook handler guide names a crate that exists
