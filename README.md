...
For more information, visit the [Symposium documentation](https://symposium.dev).

## Community

Symposium is open source. We welcome [contributors](https://symposium.dev/design/welcome.html) and maintain a [code of conduct](https://github.com/symposium-dev/symposium/blob/main/CODE_OF_CONDUCT.md).
