...
See [Authoring a plugin](./publishing-skills.md) for the full walkthrough.
...
See [Authoring a plugin](./publishing-skills.md) for the details.
...
See [Authoring a plugin](./publishing-skills.md) for how to set one up.
