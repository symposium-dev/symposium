...
The `init` command will guide you through picking your personal agent. It will then configure the agent to use Symposium (e.g., by installing hooks). This will also install a curated set of plugins, such as idiomatic Rust guidance to help your agent avoid common pitfalls.
