...
- [RFDs](./rfds/README.md)
  ...
  - [Accepted](./rfds/accepted.md) <!-- put accepted rfds in this section; the file goes in the rfds directory -->
    - [Registry-centric plugin distribution](./rfds/registry-centric-plugins/README.md)
      - [Preview](./rfds/registry-centric-plugins/preview/README.md)
        - [About page](./rfds/registry-centric-plugins/preview/about.md)
        - [Auto-discovery](./rfds/registry-centric-plugins/preview/auto-discovery.md)
        - [Workspace plugins](./rfds/registry-centric-plugins/preview/workspace.md)
      - [Plugin model](./rfds/registry-centric-plugins/plugin-model/README.md)
      - [Where clause syntax](./rfds/registry-centric-plugins/where-clauses/README.md)
      - [Discovery policy](./rfds/registry-centric-plugins/discovery/README.md)
      - [Plugin defaults](./rfds/registry-centric-plugins/plugin-defaults/README.md)
      - [User-managed plugins](./rfds/registry-centric-plugins/user-managed-plugins/README.md)
      - [Fixed-point resolution](./rfds/registry-centric-plugins/fixed-point-resolution/README.md)
      - [Custom registries](./rfds/registry-centric-plugins/custom-registries/README.md)
